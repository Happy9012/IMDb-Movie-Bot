...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('⭕️ Updates ⭕️', url='https://t.me/pocketmovieschannel')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/pocketmovieschannel'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/Pocketmoviesgroup')
            ],[
    ...
    buttons = [
        [
            InlineKeyboardButton('⭕️ Support', url='https://t.me/pocketmovieschannel'),
            InlineKeyboardButton('Channel ⭕️', url='https://t.me/Pocketmoviesgroup')
        ],
        [
            InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/pocketmovieschannel')
        ]
        ]
    await client.send_cached_media(
        chat_id=message.from_user.id,
